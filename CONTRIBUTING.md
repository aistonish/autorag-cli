...
Welcome to the contributor guide of autorag.
...
If you experience bugs or general issues with autorag, please have a look
...
You can help improve the documentation of autorag by making them more readable
...
3. Clone this copy to your local disk:
   ...
   ```console
   git clone git@github.com:YourLogin/autorag.git
   cd autorag
   ```
